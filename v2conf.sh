...
echo "请输入域名:"
read -p "示例(abc.com):" vurl
[ -z "${vurl}" ] && echo "错误,没有域名" && exit 1

echo "请输入邮箱:"
read -p "示例(abc@163.com):" vemail
...
echo "---------------------------------------------"
echo " "
echo -e "  \33[31m\33[1m执行\33[0m下面的命令替换配置文件"
...
echo "客户端配置文件v2ray-kehu.json复制到电脑上的客户端使用"
